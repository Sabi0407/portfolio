    ...
    projects: [
      {
        ...
        desc: "Installation d'un systeme Linux personnalise pour apprendre a construire un poste de travail complet et mieux comprendre chaque etape de mise en place.",
      ...
      },
      {
        ...
        desc: "Mise en place d'une plateforme pour regrouper et gerer plusieurs machines sur un meme serveur de facon plus simple et plus organisee.",
      ...
      },
      {
        ...
        desc: "Creation d'un espace de partage de fichiers sur le reseau pour stocker, retrouver et echanger des documents entre plusieurs machines.",
      ...
      },
      {
        ...
        desc: "Creation d'un serveur multimedia personnel pour organiser et regarder plus facilement mes contenus depuis plusieurs appareils.",
        tags: ["Jellyfin", "Streaming", "Multimédia", "Serveur", "Media"],
        pdf: "",
      },
      {
        title: "Mise en place proxy Caddy",
        desc: "Mise en place d'un point d'entree unique pour acceder plus facilement a mes services personnels avec une connexion securisee.",
        tags: ["Caddy", "Reverse Proxy", "HTTPS", "Réseau", "Sécurité"],
        pdf: "",
      },
      {
        title: "Mise en place de WireGuard",
        desc: "Mise en place d'un acces a distance securise pour retrouver mes machines et mes services personnels meme quand je ne suis pas chez moi.",
        tags: ["WireGuard", "VPN", "Accès distant", "Réseau", "Sécurité"],
        pdf: "",
      },
      {
        title: "Déploiement de BentoPDF via Docker",
        desc: "Installation d'un outil personnel pour gerer et convertir des fichiers PDF plus facilement dans mon environnement.",
