...
const categories = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        desc: "Création d'un espace de partage de fichiers sur le réseau pour stocker et échanger des documents entre plusieurs machines.",
        tags: ["Samba", "Partage de fichiers", "Réseau", "Permissions", "Linux"],
        pdf: "/s.sabiran/docs/samba-server.pdf",
      },
      {
        title: "Mise en place de Gotify",
        desc: "Déploiement d'un service de notifications auto-hébergé pour centraliser les alertes et recevoir les événements importants de mes services.",
        tags: ["Gotify", "Notifications", "Auto-hébergé", "Docker", "Monitoring"],
        pdf: "/s.sabiran/docs/mise-en-place-gotify.pdf",
      },
      {
        title: "Mise en place de Pi-hole",
        desc: "Installation d'un DNS filtrant pour bloquer les publicités et domaines indésirables sur l'ensemble du réseau local.",
        tags: ["Pi-hole", "DNS", "Filtrage", "Réseau", "Sécurité"],
        pdf: "/s.sabiran/docs/mise-en-place-pi-hole.pdf",
      },
      {
        title: "Mise en place de Uptime Kuma",
        desc: "Configuration d'un outil de supervision pour surveiller la disponibilité de mes services et être alerté en cas d'indisponibilité.",
        tags: ["Uptime Kuma", "Monitoring", "Supervision", "Disponibilité", "Alerting"],
        pdf: "/s.sabiran/docs/mise-en-place-uptime-kuma.pdf",
      },
      {
        title: "Déploiement de BentoPDF avec Docker",
        desc: "Installation d'un outil personnel pour gérer et convertir des fichiers PDF plus facilement dans mon environnement.",
