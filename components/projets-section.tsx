    ...
    projects: [
      {
        ...
        pdf: "/docs/installation-arch-linux.pdf",
      },
      {
        title: "Mise en place de Proxmox VE avec certificat SSL et VMs",
        desc: "Installation de Proxmox VE (hyperviseur bare-metal base sur Debian), securisation avec certificat SSL auto-signe pour l'interface web, et creation de machines virtuelles pour environnement de virtualisation.",
        tags: ["Proxmox", "SSL", "Virtualisation", "Debian", "VM"],
        pdf: "/docs/installation-proxmox.pdf",
      },
    ] as Project[],
  },
  {
    ...
    projects: [
      {
        ...
        pdf: "/docs/support-n1-groupe-bertrand.pdf",
      },
    ] as Project[],
  },
  {
    ...
    projects: [
      {
        ...
        pdf: "/docs/stage-alcasar-mise-en-place.pdf",
      },
      {
        ...
        pdf: "/docs/stage-configuration-point-acces.pdf",
      },
      {
        ...
        pdf: "/docs/stage-unbound-alcasar.pdf",
      },
      {
        ...
        pdf: "/docs/stage-modification-portail-captif.pdf",
      },
      {
        ...
        pdf: "/docs/stage-firefox-policies.pdf",
      },
      {
        ...
        pdf: "/docs/stage-taches-cron-alcasar.pdf",
      },
      {
        ...
        pdf: "/docs/stage-logs-alcasar.pdf",
      },
    ] as Project[],
  },
  {
    ...
    projects: [
      {
        ...
        pdf: "/docs/tp-openssl-apache.pdf",
      },
      {
      ...
      },
      {
        ...
        pdf: "/docs/tp-windows-server-2022.pdf",
      },
      {
      ...
      },
      {
        ...
        pdf: "/docs/tp-sauvegarde-protection.pdf",
      },
    ] as Project[],
  },
  {
    ...
    subCategories: [
      {
        ...
        projects: [
          {
            title: "Conception et developpement d'un site vitrine responsive",
            desc: "Creation complete d'un site web vitrine responsive avec HTML5, CSS3 et JavaScript vanilla. Design adaptatif multi-ecrans, animations interactives, mise en ligne et versioning du code source via GitHub.",
            tags: ["HTML", "CSS", "JavaScript", "Site vitrine", "GitHub"],
            pdf: "/docs/ap1-site-vitrine.pdf",
        ...
        projects: [
          {
            ...
            pdf: "/docs/ap4-proxmox-backup.pdf",
          },
        ] as Project[],
      },
    ],
