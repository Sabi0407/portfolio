    ...
    projects: [
      {
        ...
        desc: "Installation d'un système Linux personnalisé avec partitionnement, configuration du terminal et environnement de bureau pour mieux comprendre le fonctionnement d'un poste de travail.",
      ...
      },
      {
        ...
        desc: "Mise en place d'une plateforme de virtualisation Proxmox VE pour héberger et administrer plusieurs machines virtuelles sur un même serveur.",
      ...
      },
      {
        ...
        desc: "Mise en place d'un serveur de fichiers Samba pour centraliser le stockage, partager des documents sur le réseau et gérer les droits d'accès.",
      ...
      },
      {
        ...
        desc: "Déploiement d'un serveur multimédia Jellyfin pour organiser une bibliothèque personnelle et diffuser les contenus sur plusieurs appareils.",
        tags: ["Jellyfin", "Streaming", "Multimédia", "Serveur", "Média"],
        pdf: "",
      },
      {
        title: "Mise en place d'un proxy Caddy",
        desc: "Mise en place d'un proxy inverse Caddy pour publier mes services personnels avec HTTPS et simplifier la gestion des accès.",
        tags: ["Caddy", "Reverse Proxy", "HTTPS", "Réseau", "Sécurité"],
        pdf: "",
      },
      {
        title: "Mise en place de WireGuard",
        desc: "Mise en place d'un VPN WireGuard pour accéder à distance à mes machines et à mes services de manière sécurisée.",
        tags: ["WireGuard", "VPN", "Accès distant", "Réseau", "Sécurité"],
        pdf: "",
      },
      {
        title: "Déploiement de BentoPDF avec Docker",
        desc: "Déploiement de BentoPDF avec Docker pour gérer, convertir et organiser des fichiers PDF dans un environnement auto-hébergé.",
